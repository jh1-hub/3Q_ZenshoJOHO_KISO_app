...
import { 
  Code, Database, Brain, Cloud, Smartphone, MessageSquare, 
  MousePointerClick, Sparkles, Layers, Server, Network, Radio, 
  MapPin, CreditCard, ShoppingCart, Truck, UserCheck, AlertTriangle,
  Fingerprint, Gavel, Copyright, CreativeCommons, Cpu, HardDrive,
  Camera, Wifi, Link, Binary, RefreshCw, Clock, Settings, Download,
  Trash2, BookOpen, PenTool, FileText, Archive, Globe, Upload,
  SearchCode, Shield, Box, Activity, Target, BarChart, PieChart, Zap,
  LineChart, Lightbulb, Monitor, Terminal
} from 'lucide-react';
...
export const getRarityStyles = (rarity: Rarity) => {
  switch (rarity) {
    ...
    case 'SR':
      return {
        border: 'border-4 border-amber-400 shadow-[0_0_15px_rgba(251,191,36,0.4)]',
        bg: 'bg-gradient-to-br from-amber-400 to-orange-500',
        text: 'text-white',
        textColor: 'text-amber-500',
        label: 'Super Rare',
        accent: 'bg-theme-card/30',
    ...
    case 'R':
      return {
        border: 'border-2 border-blue-400 shadow-[0_0_10px_rgba(96,165,250,0.2)]',
        bg: 'bg-gradient-to-br from-blue-400 to-cyan-500',
        text: 'text-white',
        textColor: 'text-blue-500',
        label: 'Rare',
        accent: 'bg-theme-card/40',
    ...
    default:
      return {
        border: 'border-2 border-theme-border',
        bg: 'bg-theme-muted',
